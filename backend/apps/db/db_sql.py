...
def get_version_sql(ds: CoreDatasource, _conf: DatasourceConf) -> str:
...
def get_field_sql(
    ...
    if equals_ignore_case(ds.type, "mysql"):
        ...
        sql1 = """
               ...
               """
        sql2 = (
            " AND c.relname = %s" if table_name is not None and table_name != "" else ""
        )
        return sql1 + sql2, conf.dbSchema, table_name
    elif equals_ignore_case(ds.type, "oracle"):
        sql1 = """
