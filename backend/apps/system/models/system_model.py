...
class AssistantBaseModel(SQLModel):
    ...
    configuration: str | None = Field(sa_type=Text, nullable=True)
    create_time: int = Field(default=0, sa_type=BigInteger)
    ...
    oid: int | None = Field(nullable=True, sa_type=BigInteger, default=1)
