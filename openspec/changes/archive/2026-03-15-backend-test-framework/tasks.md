...
- [x] 2.4 Implement `auth_headers` fixture (authenticated user headers)
...
- [x] 3.4 Create mocks for LLM API calls
...
- [x] 7.3 Decide whether to archive this change or keep it open for CI hardening follow-up
