# assistant-default-datasource-entry Specification

## Purpose
Define assistant and embedded chat behavior for configured default datasource entry, visible datasource state, and switch-to-new-session handling.
