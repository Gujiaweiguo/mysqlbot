# api-key-openclaw-token-management Specification

## Purpose
Enable administrators to generate, reveal, and copy OpenClaw-ready service tokens from the API Key management UI, eliminating manual JWT construction outside mysqlbot.
